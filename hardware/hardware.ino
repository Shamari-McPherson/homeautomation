...
// //IMPORT IMAGES
// #include "Arduino.h" //Add if getting 
// #include "lockclose.h"
// #include "lockopen.h"
// #include <SPI.h>
...
//     tft.setRotation(1); // Set the screen rotation if needed (0,1,2,3)
...
//     // Draw the boxes and display zero in all of them
//   //   tft.drawRect(0, 240, 60, 60, ILI9341_BLACK); // Box 2
//   //   tft.drawRect(80, 240, 60, 60, ILI9341_BLACK); // Box 2
//   //   tft.drawRect(160, 240, 60, 60, ILI9341_BLACK);// Box 3
//   //   tft.drawRect(240, 240, 60, 60, ILI9341_BLACK);// Box 4
//   // // Draw zero in all boxes
//     digit1(0);
//     digit2(0);
//     digit3(0);
//     digit4(0);
...
//         // serializeJson(doc, message);  // Seralize / Covert JSon object to JSon string and store in char* array  {"id": "student_id", "type": “ultrasonic”,"radar": 0, "waterheight": 0, "reserve": 0, "percentage": 0}
...
//     tft.fillRoundRect(0, 240, 60, 60,10, ILI9341_BLUE); // Example: Blue color
//     // 3. Set cursor to the appropriate coordinates in order to write the number in the middle of the box 
//     tft.setCursor(25, 270); // Adjust coordinates as needed
//     // 4. Set the text colour of the number. Use any colour you like 
//     tft.setTextColor(ILI9341_WHITE); // Example: White color
...
//     tft.setFont(&FreeSansBold18pt7b); 
//     // 2. Draw a filled rounded rectangle close to the bottom of the screen. Give it any colour you like 
//     tft.fillRoundRect(80, 240, 60, 60, 10, ILI9341_BLUE); // Example: Blue color
//     // 3. Set cursor to the appropriate coordinates in order to write the number in the middle of the box 
//     tft.setCursor(95, 270); // Adjust coordinates as needed
//     // 4. Set the text colour of the number. Use any colour you like 
//     tft.setTextColor(ILI9341_WHITE); // Example: White color
//     // 5. Set font size to one 
//     tft.setTextSize(1);
...
//     tft.setFont(&FreeSansBold18pt7b); 
//     // 2. Draw a filled rounded rectangle close to the bottom of the screen. Give it any colour you like 
//     tft.fillRoundRect(160, 240, 60, 60,10, ILI9341_BLUE); // Example: Blue color
//     // 3. Set cursor to the appropriate coordinates in order to write the number in the middle of the box 
//     tft.setCursor(180, 270); // Adjust coordinates as needed
//     // 4. Set the text colour of the number. Use any colour you like 
//     tft.setTextColor(ILI9341_WHITE); // Example: White color
//     // 5. Set font size to one 
//     tft.setTextSize(1);
...
//     tft.setFont(&FreeSansBold18pt7b); 
//     // 2. Draw a filled rounded rectangle close to the bottom of the screen. Give it any colour you like 
//     tft.fillRoundRect(240, 240, 60, 60,10, ILI9341_BLUE); // Example: Blue color
//     // 3. Set cursor to the appropriate coordinates in order to write the number in the middle of the box 
//     tft.setCursor(270, 270); // Adjust coordinates as needed
//     // 4. Set the text colour of the number. Use any colour you like 
//     tft.setTextColor(ILI9341_WHITE); // Example: White color
//     // 5. Set font size to one 
//     tft.setTextSize(1);
...
//       http.begin(client, "www.yanacreations.com:8080/api/check/combination"); // Your Domain name with URL path or IP address with path 
